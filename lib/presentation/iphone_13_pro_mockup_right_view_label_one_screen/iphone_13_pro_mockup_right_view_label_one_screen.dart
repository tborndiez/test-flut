import 'controller/iphone_13_pro_mockup_right_view_label_one_controller.dart';
...
class Iphone13ProMockupRightViewLabelOneScreen
    extends GetWidget<Iphone13ProMockupRightViewLabelOneController> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
            ...
            body: Container(
                width: size.width,
                padding: getPadding(left: 30, top: 33, right: 30, bottom: 33),
                child: Column(
